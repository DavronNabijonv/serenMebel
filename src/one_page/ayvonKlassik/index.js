...
import b4 from "../../assets/images/seren/ayvon va zal/klassik/image16.jpg";
import { imagesZalKlassik } from "../../components/db/mahsulotlar";
  ...
  return (
    <div>
      <div className={styles.bolalar}>
        <p className={styles.ttl}>Ayvon zal mebellari</p>
